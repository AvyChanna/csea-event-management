...
public class Admin_ApproveActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		q.start();
		b1 = findViewById(R.id.All_Button);
		...
		JsonArrayRequest jor = new JsonArrayRequest(
				...
				new Response.Listener<JSONArray>() {
					...
					public void onResponse(JSONArray response) {
						...
						View nextChild = parentLinearLayout.getChildAt(0);
	...
	public void onFilterClick(View v) {
		...
		final EditText Et = findViewById(R.id.searchbox);
	...
	private void showProgress(final boolean show) {
		...
		for (int index = parentLinearLayout.getChildCount() - 1; index >= 0; index--) {

			View nextChild = parentLinearLayout.getChildAt(index);
			parentLinearLayout.removeView(nextChild);
	...
	public void func(View v) {
		...
		String jsonstring = "";
		TextView event_id = (TextView) l1.getChildAt(1);
		Spinner sp = (Spinner) l1.getChildAt(0);
		Spinner sp2 = (Spinner) ((ViewGroup) (l2.getChildAt(15))).getChildAt(0);

		pbar = (ProgressBar) l1.getChildAt(2);
